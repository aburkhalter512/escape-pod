...
// retryFailedFires does the DB-only retry/give-up decision, this file
// supplies the Discord-touching pieces (a fresh chat invite on a
// successful retry, editing every target message, DMing signed-up
// players, posting the chat welcome message) and fans them out. Mirrors
// expireOverduePodRounds's exact shape.
